...
maxd <- as.Date("2023-08-01", tz = "Etc/GMT-2")

raw_data_dir <- "/scratch/project_2007415/microclim/2023_data/RAS"
...
el %>% filter(site == "RAS008")
# List new error dates and codes, see the codes above
nel <- bind_rows(
  tibble(site = "RAS027", tomst_id = 94194305, start_date = as_date("2023-07-26"), end_date = as_date("2023-07-28"), probl = 1),
  tibble(site = "RAS029", tomst_id = 94184842, start_date = as_date("2022-08-19"), end_date = as_date("2023-07-28"), probl = 1),
  tibble(site = "RAS040", tomst_id = 94184854, start_date = as_date("2022-09-15"), end_date = as_date("2023-07-28"), probl = 1),
  tibble(site = "RAS042", tomst_id = 94184860, start_date = as_date("2022-08-25"), end_date = as_date("2023-07-28"), probl = 1),
  tibble(site = "RAS046", tomst_id = 94184857, start_date = as_date("2022-10-02"), end_date = as_date("2023-07-28"), probl = 1),
  tibble(site = "RAS095", tomst_id = 94194281, start_date = as_date("2022-08-24"), end_date = as_date("2023-07-28"), probl = 1)
)
