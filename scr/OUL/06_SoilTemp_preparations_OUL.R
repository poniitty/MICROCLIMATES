...
meta <- meta %>% 
  ...
  mutate(Country_code = "FI",
         ...
         Experiment_doi = "",
         Experiment_comment = "",
         Habitat_type = ifelse(Site_id %in% c("OUL079","OUL092","OUL093",
                                              "OUL008","OUL009","OUL010",
                                              "OUL065","OUL060","OUL058",
                                              "OUL057","OUL064","OUL063",
                                              "OUL103","OUL061","OUL068",
                                              "OUL019","OUL032"), 5, 1),
         Habitat_sub_type = ifelse(Site_id %in% c("OUL079","OUL092","OUL093",
                                                  "OUL008","OUL009","OUL010",
                                                  "OUL065","OUL060","OUL058",
                                                  "OUL057","OUL064","OUL063",
                                                  "OUL103","OUL061","OUL068",
