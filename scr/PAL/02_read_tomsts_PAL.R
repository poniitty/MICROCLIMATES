...
raw_data_dir <- "/scratch/project_2007415/DATA2023/Pallas2023"
...
el <- el %>%
  filter(!(site == "PAL044" & probl == 1)) %>% 
  mutate(end_date = ifelse(site == "PAL044" & probl == 1, as_date("2022-06-15"), end_date))

el %>% filter(probl == 1)

el %>% filter(site == "PAL044")
# PAL028, PAL035, PAL043, PAL044, PAL070, PAL071, PAL074, PAL075, PAL084, PAL089
# PAL124, PAL125, PAL130, PAL140, PAL142, PAL154, PAL157, PAL186, PAL187, PAL191
# List new error dates and codes, see the codes above
nel <- bind_rows(
  tibble(site = "PAL043", tomst_id = 94214326, start_date = as_date("2022-06-15"), end_date = as_date("2023-08-13"), probl = 6),
  tibble(site = "PAL044", tomst_id = 94214309, start_date = as_date("2022-06-16"), end_date = as_date("2023-08-17"), probl = 8),
  tibble(site = "PAL084", tomst_id = 94214307, start_date = as_date("2022-06-14"), end_date = as_date("2023-08-17"), probl = 8),
  tibble(site = "PAL089", tomst_id = 94214308, start_date = as_date("2022-06-14"), end_date = as_date("2023-08-17"), probl = 8),
  tibble(site = "PAL124", tomst_id = 95253628, start_date = as_date("2023-07-31"), end_date = as_date("2023-08-12"), probl = 6)
)
