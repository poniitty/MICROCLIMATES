...
data_dir <- "/scratch/project_2007415/DATA2023/Pisa2023"
...
# bind_rows(read_csv("/projappl/project_2003061/repos/microclim_pisa/data/reading_times_2020.csv"),
#           read_csv("/projappl/project_2003061/repos/microclim_pisa/data/reading_times_2021.csv"),
#           read_csv("/projappl/project_2003061/repos/microclim_pisa/data/reading_times_2022.csv")) %>%
#   distinct() %>%
