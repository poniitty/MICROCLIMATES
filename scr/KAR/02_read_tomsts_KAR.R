...
raw_data_dir <- "/scratch/project_2007415/microclim/2023_data/KAR"
old_data_dir <- "/projappl/project_2003061/repos/microclim_karkali/output/"
...
# el <- read_csv("/projappl/project_2003061/repos/microclim_karkali/output/error_log.csv") %>%
