...
raw_data_dir <- "/scratch/project_2007415/DATA2023/Tiilikka2023/"
old_data_dir <- "/projappl/project_2003061/repos/microclim_tiilikka/output/"
...
# visittimes <- visittimes %>% filter(year(maxdt) < 2023)
...
# el <- read_csv("/projappl/project_2003061/repos/microclim_tiilikka/output/error_log.csv") %>%
...
el %>% filter(site == "TII041")
# List new error dates and codes, see the codes above
nel <- bind_rows(
  tibble(site = "TII007", tomst_id = 94194368, start_date = as_date("2022-05-10"), end_date = as_date("2023-08-02"), probl = 3),
  tibble(site = "TII041", tomst_id = 94194365, start_date = as_date("2022-05-10"), end_date = as_date("2023-08-02"), probl = 3),
  tibble(site = "TII039", tomst_id = 94194256, start_date = as_date("2023-05-21"), end_date = as_date("2023-08-02"), probl = 1),
  tibble(site = "TII008", tomst_id = 94190042, start_date = as_date("2023-08-02"), end_date = as_date("2023-08-02"), probl = 2),
  tibble(site = "TII015", tomst_id = 94190041, start_date = as_date("2023-08-02"), end_date = as_date("2023-08-02"), probl = 2),
  tibble(site = "TII030", tomst_id = 94194408, start_date = as_date("2023-08-02"), end_date = as_date("2023-08-02"), probl = 2),
  tibble(site = "TII045", tomst_id = 94194362, start_date = as_date("2023-08-03"), end_date = as_date("2023-08-06"), probl = 2)
)
