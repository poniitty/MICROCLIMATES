...
raw_data_dir <- "/scratch/project_2007415/DATA2023/HYY2023/"
old_data_dir <- "/projappl/project_2003061/repos/microclim_hyytiala/output/"
...
# el <- read_csv("/projappl/project_2003061/repos/microclim_hyytiala/output/error_log.csv") %>% 
...
el %>% filter(site == "HYY053")
# List new error dates and codes, see the codes above
nel <- bind_rows(
  tibble(site = "HYY016", tomst_id = 95224054, start_date = as_date("2022-10-01"), end_date = as_date("2022-10-19"), probl = 2),
  tibble(site = "HYY025", tomst_id = 95224051, start_date = as_date("2022-10-01"), end_date = as_date("2022-10-19"), probl = 2),
  tibble(site = "HYY032", tomst_id = 94194356, start_date = as_date("2023-06-08"), end_date = as_date("2023-10-27"), probl = 1),
  tibble(site = "HYY053", tomst_id = 95224061, start_date = as_date("2022-10-01"), end_date = as_date("2022-10-19"), probl = 2)
)
